...
import 'schema/file_names_record.dart';
...
export 'schema/file_names_record.dart';
...
/// Functions to query FileNamesRecords (as a Stream and as a Future).
Future<int> queryFileNamesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      FileNamesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<FileNamesRecord>> queryFileNamesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      FileNamesRecord.collection,
      FileNamesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<FileNamesRecord>> queryFileNamesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
