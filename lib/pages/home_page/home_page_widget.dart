...
import '/notes/deletenote/deletenote_widget.dart';
import '/index.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              Align(
                alignment: AlignmentDirectional(-1.0, 0.0),
                child: Padding(
                  padding: EdgeInsetsDirectional.fromSTEB(50.0, 60.0, 0.0, 0.0),
                  child: Column(
                    mainAxisSize: MainAxisSize.max,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                          ...
                          children: [
                            ...
                            Container(
                              ...
                              child: FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  context.pushNamed(StorageWidget.routeName);
                                },
                              ),
                            ),
                          ],
                    ...
                    child: StreamBuilder<List<NotesRecord>>(
                      stream: queryNotesRecord(
                        queryBuilder: (notesRecord) =>
                            notesRecord.orderBy('creationDate'),
                      ),
                        ...
                        child: StreamBuilder<List<EventsRecord>>(
                          stream: queryEventsRecord(
                            queryBuilder: (eventsRecord) => eventsRecord
                                ...
                                .orderBy('Time')
                                .orderBy('PrioLevel', descending: true)
                                .orderBy('timeCreated'),
                          ),
                          builder: (context, snapshot) {
                            // Customize what your widget looks like when it's loading.
