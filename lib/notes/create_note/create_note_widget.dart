...
class CreateNoteWidget extends StatefulWidget {
  ...
  static String routeName = 'CreateNote';
  static String routePath = '/createNote';
    ...
    return GestureDetector(
      ...
      child: Scaffold(
        ...
        floatingActionButton: FloatingActionButton.extended(
          onPressed: () async {
            await NotesRecord.collection.doc().set(createNotesRecordData(
                  creationDate: getCurrentTimestamp,
                  noteContent: _model.textController.text,
                ));
            context.safePop();
          },
