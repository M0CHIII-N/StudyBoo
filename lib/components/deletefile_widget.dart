...
import 'deletefile_model.dart';
export 'deletefile_model.dart';
...
class DeletefileWidget extends StatefulWidget {
  ...
  final DocumentReference? filename;
          ...
          children: [
            Padding(
              ...
              child: FFButtonWidget(
                onPressed: () async {
                  await widget.filename!.delete();
                  await deleteSupabaseFileFromPublicUrl(widget.fileURL!);
